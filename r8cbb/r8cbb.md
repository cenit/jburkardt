R8CBB\
Compact Border Banded Linear Algebra Utilities {#r8cbb-compact-border-banded-linear-algebra-utilities align="center"}
==============================================

------------------------------------------------------------------------

**R8CBB** is a C++ library which carries out some basic linear algebra
operations on R8CBB matrices (real 64 bit precision compact border
banded format).
...
**R8CBB** is available in [a C version](../../c_src/r8cbb/r8cbb.html)
and [a C++ version](../../cpp_src/r8cbb/r8cbb.html) and [a FORTRAN90
version](../../f_src/r8cbb/r8cbb.html) and [a MATLAB
version](../../m_src/r8cbb/r8cbb.html) and [a Python
version.](../../py_src/r8cbb/r8cbb.html)
...
-   [r8cbb.cpp](r8cbb.cpp), the source code.
-   [r8cbb.hpp](r8cbb.hpp), the source code.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8cbb\_prb.cpp](r8cbb_prb.cpp), a sample calling program.
-   [r8cbb\_prb\_output.txt](r8cbb_prb_output.txt), the output file.
...
-   **R8CBB\_ADD** adds a value to an entry of an R8CBB matrix.
-   **R8CBB\_DIF2** sets up an R8CBB second difference matrix.
-   **R8CBB\_FA** factors an R8CBB matrix.
-   **R8CBB\_GET** gets the value of an entry of an R8CBB matrix.
-   **R8CBB\_INDICATOR** sets up an R8CBB indicator matrix.
-   **R8CBB\_MTV** multiplies a vector by an R8CBB matrix.
-   **R8CBB\_MV** multiplies an R8CBB matrix times a vector.
-   **R8CBB\_PRINT** prints an R8CBB matrix.
-   **R8CBB\_PRINT\_SOME** prints some of an R8CBB matrix.
-   **R8CBB\_RANDOM** randomizes an R8CBB matrix.
-   **R8CBB\_SET** sets an entry of an R8CBB matrix.
-   **R8CBB\_SL** solves an R8CBB system factored by R8CBB\_FA.
-   **R8CBB\_TO\_R8GE** copies an R8CBB matrix to an R8GE matrix.
-   **R8CBB\_ZEROS** zeros an R8CBB matrix.
