HYPERSPHERE\_MONTE\_CARLO\
Monte Carlo Estimate of Hypersphere Surface Integrals {#hypersphere_monte_carlo-monte-carlo-estimate-of-hypersphere-surface-integrals align="center"}
=====================================================

------------------------------------------------------------------------

**HYPERSPHERE\_MONTE\_CARLO** is a C++ library which estimates the
integral of F(X) over the surface of the unit hypersphere in M
dimensions.
...
**HYPERSPHERE\_MONTE\_CARLO** is available in [a C
version](../../c_src/hypersphere_monte_carlo/hypersphere_monte_carlo.html)
and [a C++
version](../../cpp_src/hypersphere_monte_carlo/hypersphere_monte_carlo.html)
and [a FORTRAN77
version](../../f77_src/hypersphere_monte_carlo/hypersphere_monte_carlo.html)
and [a FORTRAN90
version](../../f_src/hypersphere_monte_carlo/hypersphere_monte_carlo.html)
and [a MATLAB
version](../../m_src/hypersphere_monte_carlo/hypersphere_monte_carlo.html)
and [a Python
version](../../py_src/hypersphere_monte_carlo/hypersphere_monte_carlo.html).
...
surface of the unit hypersphere in M dimensions.
...
*Last revised on 04 January 2014.*
