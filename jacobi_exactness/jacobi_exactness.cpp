...
double monomial_quadrature_jacobi ( int expon, double alpha, double beta,
...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "JACOBI_EXACTNESS\n";
  cout << "  C++ version\n";
  cout << "\n";
  cout << "  Compiled on " << __DATE__ << " at " << __TIME__ << ".\n";
  cout << "\n";
  cout << "  Investigate the polynomial exactness of a Gauss-Jacobi\n";
...
//
  ...
  {
    cout << "\n";
    cout << "ALPHA is the power of (1-X) in the weighting function.\n";
    cout << "\n";
...
//
  ...
  {
    cout << "\n";
    cout << "BETA is the power of (1+X) in the weighting function.\n";
    cout << "\n";
    cout << "BETA is a real number greater than -1.0.\n";
    cin >> beta;
  }
//
//  Summarize the input.
//
  cout << "\n";
  cout << "JACOBI_EXACTNESS: User input:\n";
  ...
  cout << "  Exponent of (1-x), ALPHA = " << alpha << "\n";
  cout << "  Exponent of (1+x), BETA  = " << beta << "\n";
//
//  Read the X file.
//
  ...
  {
    cout << "\n";
    cout << "JACOBI_EXACTNESS - Fatal error!\n";
...
//
  ...
  cout << "  a Gauss-Jacobi rule\n";
  cout << "  ORDER = " << order << "\n";
  cout << "  ALPHA = " << alpha << "\n";
  cout << "  BETA  = " << beta << "\n";
  cout << "\n";
  cout << "  Standard rule:\n";
  cout << "    Integral ( -1 <= x <= +1 ) (1-x)^alpha (1+x)^beta f(x) dx\n";
...
//
  cout << "\n";
  cout << "  A Gauss-Jacobi rule would be able to exactly\n";
  ...
  {
    quad_error = monomial_quadrature_jacobi ( degree, alpha, beta, 
    order, w, x );
