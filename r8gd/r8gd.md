R8GD\
General Diagonal Linear Algebra Utilities {#r8gd-general-diagonal-linear-algebra-utilities align="center"}
=========================================

------------------------------------------------------------------------

**R8GD** is a C++ library which carries out some basic linear algebra
operations on R8GD matrices (real 64 bit precision general diagonal
format).
...
**R8GD** is available in [a C version](../../c_src/r8gd/r8gd.html) and
[a C++ version](../../cpp_src/r8gd/r8gd.html) and [a FORTRAN90
version](../../f_src/r8gd/r8gd.html) and [a MATLAB
version](../../m_src/r8gd/r8gd.html) and [a Python
version.](../../py_src/r8gd/r8gd.html)
...
-   [r8gd.cpp](r8gd.cpp), the source code.
-   [r8gd.hpp](r8gd.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8gd\_prb.cpp](r8gd_prb.cpp) a sample calling program.
-   [r8gd\_prb\_output.txt](r8gd_prb_output.txt), the output file.
...
-   **R8GD\_DIF2** sets up an R8GD second difference matrix.
-   **R8GD\_INDICATOR** sets up an R8GD indicator matrix.
-   **R8GD\_MTV** multiplies a vector by an R8GD matrix.
-   **R8GD\_MV** multiplies an R8GD matrix by a vector.
-   **R8GD\_PRINT** prints an R8GD matrix.
-   **R8GD\_PRINT\_SOME** prints some of an R8GD matrix.
-   **R8GD\_RANDOM** randomizes an R8GD matrix.
-   **R8GD\_TO\_R8GE** copies an R8GD matrix to an R8GE matrix.
-   **R8GD\_ZEROS** zeros an R8GD matrix.
