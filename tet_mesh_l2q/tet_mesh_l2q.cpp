...
//
  ...
  {
    cerr << "\n";
    cerr << "TET_MESH_L2Q - Fatal error!\n";
    cerr << "  The spatial dimension must be 3.\n";
    cerr << "  This data has dimension = " << dim_num << "\n";
    exit ( 1 );
  }
...
//
  ...
  if ( element_order1 != 4 )
  {
    cerr << "\n";
    cerr << "TET_MESH_L2Q - Fatal error!\n";
    cerr << "  The tet mesh must have order 4.\n";
    cerr << "  This mesh has order " << element_order1 << "\n";
    exit ( 1 );
  }
...
//  Parameters:
//
//    Input/output, int I1, I2, the values to be sorted.
//
//    Input/output, int &J1, &J2, the sorted values.
//
{
  int k1;
  int k2;
...
//
    if ( n1 != n1_old || n2 != n2_old )
    {
      ...
      {
        cerr << "\n";
        cerr << "TET_MESH_ORDER4_TO_ORDER10_COMPUTE - Fatal error!\n";
        cerr << "  Node index exceeds NODE_NUM2.\n";
        exit ( 1 );
      }
