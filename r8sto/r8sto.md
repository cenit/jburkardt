R8STO\
Symmetric Toeplitz Matrix Utilities {#r8sto-symmetric-toeplitz-matrix-utilities align="center"}
===================================

------------------------------------------------------------------------

**R8STO** is a C++ library which carries out some basic linear algebra
operations on R8STO matrices (real 64 bit precision symmetric Toeplitz N
format).
...
**R8STO** is available in [a C version](../../c_src/r8sto/r8sto.html)
and [a C++ version](../../cpp_src/r8sto/r8sto.html) and [a FORTRAN90
version](../../f_src/r8sto/r8sto.html) and [a MATLAB
version](../../m_src/r8sto/r8sto.html) and [a Python
version.](../../py_src/r8sto/r8sto.html)

### Related Data and Programs: {#related-data-and-programs align="center"}

[R83](../../cpp_src/r83/r83.html), a C++ library which contains linear
algebra routines for R83 matrices (real, 64 bit, tridiagonal format).
...
-   [r8sto.cpp](r8sto.cpp), the source code.
-   [r8sto.hpp](r8sto.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8sto\_prb.cpp](r8sto_prb.cpp), a sample calling program.
-   [r8sto\_prb\_output.txt](r8sto_prb_output.txt), the output file.
...
-   **R8STO\_DIF2** sets the second difference as an R8STO matrix.
-   **R8STO\_INDICATOR** sets up an R8STO indicator matrix.
-   **R8STO\_INVERSE** computes the inverse of an R8STO matrix.
-   **R8STO\_MV** multiplies an R8STO matrix by an R8VEC.
-   **R8STO\_PRINT** prints an R8STO matrix.
-   **R8STO\_PRINT\_SOME** prints some of an R8STO matrix.
-   **R8STO\_RANDOM** randomizes an R8STO matrix.
-   **R8STO\_SL** solves an R8STO system.
-   **R8STO\_TO\_R8GE** copies an R8STO matrix to an R8GE matrix.
-   **R8STO\_YW\_SL** solves the Yule-Walker equations for an R8STO
    matrix.
-   **R8STO\_ZEROS** zeroes an R8STO matrix.
