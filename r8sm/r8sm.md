R8SM\
Sherman-Morrison Matrix Utilities {#r8sm-sherman-morrison-matrix-utilities align="center"}
=================================

------------------------------------------------------------------------

**R8SM** is a C++ library which carries out some basic linear algebra
operations on R8SM matrices (real 64 bit precision Sherman-Morrison
A-u\*v format).
...
**R8SM** is available in [a C version](../../c_src/r8sm/r8sm.html) and
[a C++ version](../../cpp_src/r8sm/r8sm.html) and [a FORTRAN90
version](../../f_src/r8sm/r8sm.html) and [a MATLAB
version](../../m_src/r8sm/r8sm.html) and [a Python
version.](../../py_src/r8sm/r8sm.html)
...
-   [r8sm.cpp](r8sm.cpp), the source code.
-   [r8sm.hpp](r8sm.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8sm\_prb.cpp](r8sm_prb.cpp) a sample calling program.
-   [r8sm\_prb\_output.txt](r8sm_prb_output.txt), the output file.
...
-   **R8SM\_INDICATOR** returns the indicator matrix as an R8SM matrix.
-   **R8SM\_ML** multiplies a factored square R8SM matrix times a
    vector.
-   **R8SM\_MTV** multiplies a vector by an R8SM matrix.
-   **R8SM\_MV** multiplies an R8SM matrix times a vector.
-   **R8SM\_PRINT** prints an R8SM matrix.
-   **R8SM\_PRINT\_SOME** prints some of an R8SM matrix.
-   **R8SM\_RANDOM** randomizes an R8SM matrix.
-   **R8SM\_SL** solves a square R8SM system that has been factored.
-   **R8SM\_TO\_R8GE** copies an R8SM matrix to an R8GE matrix.
-   **R8SM\_ZEROS** zeros an R8SM matrix.
