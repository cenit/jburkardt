R8TO\
Toeplitz Matrix Utilities {#r8to-toeplitz-matrix-utilities align="center"}
=========================

------------------------------------------------------------------------

**R8TO** is a C++ library which carries out some basic linear algebra
operations on R8TO matrices (real 64 bit precision Toeplitz 2\*N-1
format).
...
**R8TO** is available in [a C version](../../c_src/r8to/r8to.html) and
[a C++ version](../../cpp_src/r8to/r8to.html) and [a FORTRAN90
version](../../f_src/r8to/r8to.html) and [a MATLAB
version](../../m_src/r8to/r8to.html) and [a Python
version.](../../py_src/r8to/r8to.html)
...
-   [r8to.c](r8to.c), the source code.
-   [r8to.h](r8to.h), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8to\_prb.c](r8to_prb.c), a sample calling program.
-   [r8to\_prb\_output.txt](r8to_prb_output.txt), the output file.
...
-   **R8TO\_DIF2** sets the second difference as an R8TO matrix.
-   **R8TO\_INDICATOR** sets up an R8TO indicator matrix.
-   **R8TO\_MTV** multiplies an R8VEC by an R8TO matrix.
-   **R8TO\_MV** multiplies an R8TO matrix by an R8VEC.
-   **R8TO\_PRINT** prints an R8TO matrix.
-   **R8TO\_PRINT\_SOME** prints some of an R8TO matrix.
-   **R8TO\_RANDOM** randomizes an R8TO matrix.
-   **R8TO\_SL** solves an R8TO system.
-   **R8TO\_SLT** solves the system A'\*x=b, where A is an R8TO matrix.
-   **R8TO\_TO\_R8GE** copies an R8TO matrix to an R8GE matrix.
-   **R8TO\_ZEROS** zeroes an R8TO matrix.
