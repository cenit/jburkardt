...
//
  ...
  for ( i = 1; i <= P; i++ )
  {
    row = c8vec_uniform_01_new ( P, seed );
...
//
  ...
  a = c8mat_uniform_01_new ( N, N, seed );
...
# define P 3
  ...
  cout << "\n";
  cout << "ZQRDC_TEST\n";
  cout << "  ZQRDC computes the QR decomposition of a rectangular\n";
...
//
  ...
  a = c8mat_uniform_01_new ( N, P, seed );
