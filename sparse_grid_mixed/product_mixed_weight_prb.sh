#!/bin/bash
#
g++ -c -I/$HOME/include product_mixed_weight_prb.cpp
if [ $? -ne 0 ]; then
  echo "Errors compiling product_mixed_weight_prb.cpp"
  exit
fi
#
g++ product_mixed_weight_prb.o /$HOME/libcpp/$ARCH/sparse_grid_mixed.o /$HOME/libcpp/$ARCH/sandia_rules.o -lm
if [ $? -ne 0 ]; then
