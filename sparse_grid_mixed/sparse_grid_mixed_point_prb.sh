#!/bin/bash
#
g++ -c -I/$HOME/include sparse_grid_mixed_point_prb.cpp
if [ $? -ne 0 ]; then
  echo "Errors compiling sparse_grid_mixed_point_prb.cpp"
  exit
fi
#
g++ sparse_grid_mixed_point_prb.o /$HOME/libcpp/$ARCH/sparse_grid_mixed.o /$HOME/libcpp/$ARCH/sandia_rules.o -lm
if [ $? -ne 0 ]; then
