R8PP\
Positive Definite Packed Matrix Utilities {#r8pp-positive-definite-packed-matrix-utilities align="center"}
=========================================

------------------------------------------------------------------------

**R8PP** is a C++ library which carries out some basic linear algebra
operations on R8PP matrices (real 64 bit precision positive definite
...
**R8PP** is available in [a C version](../../c_src/r8pp/r8pp.html) and
[a C++ version](../../cpp_src/r8pp/r8pp.html) and [a FORTRAN90
version](../../f_src/r8pp/r8pp.html) and [a MATLAB
version](../../m_src/r8pp/r8pp.html) and [a Python
version](../../py_src/r8pp/r8pp.html)
...
-   [r8pp.cpp](r8pp.cpp), the source code.
-   [r8pp.hpp](r8pp.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8pp\_prb.cpp](r8pp_prb.cpp) a sample calling program.
-   [r8pp\_prb\_output.txt](r8pp_prb_output.txt), the output file.
...
-   **R8PP\_DET** computes the determinant of a matrix factored by
    R8PP\_FA.
-   **R8PP\_DIF2** sets up an R8PP second difference matrix.
-   **R8PP\_FA** factors an R8PP matrix.
-   **R8PP\_INDICATOR** sets up an R8PP indicator matrix.
-   **R8PP\_MV** multiplies an R8PP matrix times a vector.
-   **R8PP\_PRINT** prints an R8PP matrix.
-   **R8PP\_PRINT\_SOME** prints some of an R8PP matrix.
-   **R8PP\_RANDOM** randomizes an R8PP matrix.
-   **R8PP\_SL** solves an R8PP system factored by R8PP\_FA.
-   **R8PP\_TO\_R8GE** copies an R8PP matrix to an R8GE matrix.
-   **R8PP\_ZEROS** zeros an R8PP matrix.
