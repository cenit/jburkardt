...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "FEM_TO_TRIANGLE\n";
  cout << "  C++ version:\n";
  cout << "  Convert a 2D mesh from FEM to TRIANGLE format.\n";
  cout << "\n";
  cout << "  Read:\n";
  cout << "  * \"prefix\"_nodes.txt, FEM node coordinates.\n";
  cout << "  * \"prefix\"_elements.txt, FEM element connectivities.\n";
  cout << "\n";
  cout << "  Create:\n";
  cout << "  * \"prefix\".node, TRIANGLE node coordinates.\n";
  cout << "  * \"prefix\".ele, TRIANGLE element connectivities.\n";
//
...
//
  ...
  triangle_node_filename + ".node";
  triangle_element_filename + ".ele";
//
//  Read the node data.
//
  ...
  cout << "\n";
  cout << "  Read the header of \"" << fem_node_filename << "\".\n";
  cout << "\n";
  ...
  {
    cerr << "\n";
    cerr << "FEM_TO_TRIANGLE - Fatal error!\n";
    cerr << "  Spatial dimension must be 2.\n";
    exit ( 1 );
  }
  node_x = r8mat_data_read ( fem_node_filename, m, node_num );

  cout << "\n";
  cout << "  Read the data in \"" << fem_node_filename << "\".\n";
...
//
  ...
  cout << "\n";
  cout << "  Read the header of \"" << fem_element_filename << "\".\n";
  cout << "\n";
  ...
  cout << "\n";
  cout << "  Read the data in \"" << fem_element_filename << "\".\n";
...
//
  ...
  cout << "\n";
  cout << "  Created the TRIANGLE element file \"" << triangle_element_filename << "\".\n";
  ...
  cout << "  Created the TRIANGLE node file \"" << triangle_node_filename << "\".\n";
//
//  Free memory.
//
  free ( element_node );
