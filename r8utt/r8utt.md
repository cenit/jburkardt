R8UTT\
Upper Triangular Toeplitz Matrix Utilities {#r8utt-upper-triangular-toeplitz-matrix-utilities align="center"}
==========================================

------------------------------------------------------------------------

**R8UTT** is a C++ library which carries out some basic linear algebra
operations on R8UTT matrices (real 64 bit precision upper triangular
Toeplitz format).
...
**R8UTT** is available in [a C version](../../c_src/r8utt/r8utt.html)
and [a C++ version](../../cpp_src/r8utt/r8utt.html) and [a FORTRAN90
version](../../f_src/r8utt/r8utt.html) and [a MATLAB
version](../../m_src/r8utt/r8utt.html) and [a Python
version](../../py_src/r8utt/r8utt.html)
...
-   [r8utt.cpp](r8utt.cpp), the source code.
-   [r8utt.hpp](r8utt.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8utt\_prb.cpp](r8utt_prb.cpp), a sample calling program.
-   [r8utt\_prb\_output.txt](r8utt_prb_output.txt), the output file.
...
-   **R8UTT\_DET** computes the determinant of a R8UTT matrix.
-   **R8UTT\_INDICATOR** sets up a R8UTT indicator matrix.
-   **R8UTT\_INVERSE** computes the inverse of a R8UTT matrix.
-   **R8UTT\_MM** computes C = A \* B, where A and B are R8UTT matrices.
-   **R8UTT\_MTM** computes C = A' \* B, where A and B are R8UTT
    matrices.
-   **R8UTT\_MTV** computes b = A'\*x, where A is an R8UTT matrix.
-   **R8UTT\_MV** computes b=A\*x, where A is an R8UTT matrix.
-   **R8UTT\_PRINT** prints an R8UTT matrix.
-   **R8UTT\_PRINT\_SOME** prints some of an R8UTT matrix.
-   **R8UTT\_RANDOM** randomizes an R8UTT matrix.
-   **R8UTT\_SL** solves a linear system A\*x=b with an R8UTT matrix.
-   **R8UTT\_SLT** solves a linear system A'\*x=b with an R8UTT matrix.
-   **R8UTT\_TO\_R8GE** copies an R8UTT matrix to an R8GE matrix.
-   **R8UTT\_ZEROS** zeros an R8UTT matrix.
