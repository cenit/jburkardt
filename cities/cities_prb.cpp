...
void dms_to_xy_test ( string prefix );
void dist_table_check_test ( string prefix );
...
//
{
  ...
  filename = "usca312";
  dms_to_xy_test ( filename );

  filename = "spaeth2_09";
  dist_table_check_test ( filename );
//
//  Terminate.
//
  cout << "\n";
