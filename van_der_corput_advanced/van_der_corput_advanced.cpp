...
# include "van_der_corput_advanced.hpp"
...
//
{
  ...
  {
    cerr << "\n";
    cerr << "I4_TO_VAN_DER_CORPUT_SEQUENCE - Fatal error!\n";
    cerr << "  The input base BASE is <= 1!\n";
    cerr << "  BASE = " << base << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    cerr << "\n";
    cerr << "VAN_DER_CORPUT_BASE_SET - Fatal error!\n";
    cerr << "  The input base BASE is <= 1!\n";
    cerr << "  BASE = " << base << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    cerr << "\n";
    cerr << "VAN_DER_CORPUT_SEED_SET - Fatal error!\n";
    cerr << "  SEED < 0.";
    cerr << "  SEED = " << seed << "\n";
    exit ( 1 );
  }
