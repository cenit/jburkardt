#!/bin/bash
#
cp ~/public.md/datasets/sparse_grid_mixed/sparse_grid_mixed_d2_l2_ccxglg_a.txt .
cp ~/public.md/datasets/sparse_grid_mixed/sparse_grid_mixed_d2_l2_ccxglg_b.txt .
cp ~/public.md/datasets/sparse_grid_mixed/sparse_grid_mixed_d2_l2_ccxglg_r.txt .
cp ~/public.md/datasets/sparse_grid_mixed/sparse_grid_mixed_d2_l2_ccxglg_w.txt .
cp ~/public.md/datasets/sparse_grid_mixed/sparse_grid_mixed_d2_l2_ccxglg_x.txt .
#
