R8NCF\
Nonsymmetric Coordinate Format Linear Algebra Utilities {#r8ncf-nonsymmetric-coordinate-format-linear-algebra-utilities align="center"}
=======================================================

------------------------------------------------------------------------

**R8NCF** is a C++ library which carries out some basic linear algebra
operations on R8NCF matrices (real 64 bit precision Nonsymmetric
Coordinate Format).
...
**R8NCF** is available in [a C version](../../cpp_src/r8ncf/r8ncf.html)
and [a C++ version](../../cpp_src/r8ncf/r8ncf.html) and [a FORTRAN90
version](../../f_src/r8ncf/r8ncf.html) and [a MATLAB
version](../../m_src/r8ncf/r8ncf.html) and [a Python
version.](../../py_src/r8ncf/r8ncf.html)
...
-   [r8ncf.cpp](r8ncf.cpp), the source code.
-   [r8ncf.hpp](r8ncf.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8ncf\_prb.cpp](r8ncf_prb.cpp), a sample calling program.
-   [r8ncf\_prb\_output.txt](r8ncf_prb_output.txt), the output file.
...
-   **R8NCF\_DIF2** sets up an R8NCF second difference matrix.
-   **R8NCF\_INDICATOR** sets up an R8NCF indicator matrix.
-   **R8NCF\_MTV** multiplies the transpose of an R8NCF matrix by an
    R8VEC.
-   **R8NCF\_MV** multiplies an R8NCF matrix by an R8VEC.
-   **R8NCF\_PRINT** prints an R8NCF matrix.
-   **R8NCF\_PRINT\_SOME** prints some of an R8NCF matrix.
-   **R8NCF\_RANDOM** randomizes an R8NCF matrix.
-   **R8NCF\_TO\_R8GE** copies an R8NCF matrix to an R8GE matrix.
-   **R8NCF\_ZEROS** zeroes an R8NCF matrix.
