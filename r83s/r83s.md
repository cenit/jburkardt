R83S\
Tridiagonal Matrix Utilities {#r83s-tridiagonal-matrix-utilities align="center"}
============================

------------------------------------------------------------------------

**R83S** is a C++ library which carries out some basic linear algebra
operations on R83S matrices (real 64 bit precision tridiagonal scalar
format).
...
**R83S** is available in [a C version](../../c_src/r83s/r83s.html) and
[a C++ version](../../cpp_src/r83s/r83s.html) and [a FORTRAN90
version](../../f_src/r83s/r83s.html) and [a MATLAB
version](../../m_src/r83s/r83s.html) and [a Python
version.](../../py_src/r83s/r83s.html)
...
-   [r83s.cpp](r83s.cpp), the source code.
-   [r83s.hpp](r83s.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r83s\_prb.cpp](r83s_prb.cpp), a sample calling program.
-   [r83s\_prb\_output.txt](r83s_prb_output.txt), the output file.
...
-   **R83S\_GS\_SL** solves an R83S system using Gauss-Seidel iteration.
-   **R83S\_INDICATOR** sets up an R83s indicator matrix.
-   **R83S\_JAC\_SL** solves an R83S system using Jacobi iteration.
-   **R83S\_MTV** multiplies a vector times an R83S matrix.
-   **R83S\_MV** multiplies an R83S matrix times a vector.
-   **R83S\_PRINT** prints an R83S matrix.
-   **R83S\_PRINT\_SOME** prints some of an R83S matrix.
-   **R83S\_RANDOM** randomizes an R83S matrix.
-   **R83S\_RES** computes the residual R = B-A\*X for R83S matrices.
-   **R83S\_TO\_R8GE** copies an R83S matrix to an R8GE matrix.
-   **R83S\_ZEROS** zeros an R83S matrix.
...
*Last revised on 05 September 2015.*
