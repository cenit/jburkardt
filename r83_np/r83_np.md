R83\_NP\
Tridiagonal Matrix Utilities, Nonpivoting Factorization {#r83_np-tridiagonal-matrix-utilities-nonpivoting-factorization align="center"}
=======================================================

------------------------------------------------------------------------

**R83\_NP** is a C++ library which carries out some basic linear algebra
operations on R83\_NP matrices (real 64 bit precision tridiagonal 3xN
format, nonpivoting factorization).

These utilities are distinguished by the fact that an LU factorization
is attempted without the use of pivoting. Such an approach will fail if
a zero pivot is encountered, and will generally not be as accurate as a
pivoting factorization. It is only recommended in cases where pivoting
is known to be unnecessary, such as for a symmetric positive definite
matrix.
...
**R83\_NP** is available in [a C
version](../../c_src/r83_np/r83_np.html) and [a C++
version](../../cpp_src/r83_np/r83_np.html) and [a FORTRAN90
version](../../f_src/r83_np/r83_np.html) and [a MATLAB
version](../../m_src/r83_np/r83_np.html) and [a Python
version.](../../py_src/r83_np/r83_np.html)
...
-   [r83\_np.cpp](r83_np.cpp), the source code.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r83\_np\_prb.cpp](r83_np_prb.cpp), a sample calling program.
-   [r83\_np\_prb\_output.txt](r83_np_prb_output.txt), the output file.
...
-   **R83\_NP\_DET:** determinant of a tridiagonal system factored by
    R83\_NP\_FA.
-   **R83\_NP\_FA** factors an R83 system without pivoting.
-   **R83\_NP\_FS** factors and solves an R83 system.
