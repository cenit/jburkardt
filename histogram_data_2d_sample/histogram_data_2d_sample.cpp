...
//
{
  ...
  cout << "\n";
  cout << "TEST01\n";
  cout << "  Consider data skewed toward the upper left corner of the unit square.\n";
  cout << "  Generate " << n << " samples\n";
//
//  Get the dimensions of the PDF data.
//
  get_discrete_pdf_size1 ( n1, n2 );
  cout << "  PDF data is on a " << n1 << " by " << n2 << " grid.\n";
//
...
//
{
  ...
  cout << "\n";
  cout << "TEST02\n";
  cout << "  Consider data suggested by the shape and density of Iowa.\n";
  cout << "  Generate " << n << " samples\n";
//
//  Get the dimensions of the PDF data.
//
