...
//
{
  const float alnhaf = -0.693147180559945309E+00;
  float ampl;
  static float bm0cs[21] = {
   +0.09284961637381644E+00,
   -0.00142987707403484E+00,
  ...
  const float pi4 = 0.78539816339744831E+00;
  float theta;
  const float twodpi = 0.63661977236758134E+00;
  float value;
  static float xmax = 0.0;
  static float xsml = 0.0;
  float y;
...
//
{
  const float atr = 8.7506905708484345E+00;
  static float bif2cs[10] = {
     0.323493987603522033521E+00,
     0.086297871535563559139E+00,
     0.002994025552655397426E+00,
  ...
  const float btr = -2.0938363213560543E+00;
  float eta;
  static int nbif = 0;
  static int nbif2 = 0;
  static int nbig = 0;
...
//
{
  ...
  static float bipcs[24] = {
   ...
   -0.00000000000000011E+00,
    0.00000000000000001E+00 };
  const float btr = -2.093836321356054E+00;
  float eta;
  static int nbif;
  static int nbif2;
  static int nbig;
...
//
{
  ...
  int i;
  int k;
  const float sq2pil = 0.91893853320467274E+00;
  float value;
  float xk;
  float xn;
  float xnk;
...
//
{
  ...
  int m;
  int n;
  const float pi = 3.14159265358979324E+00;
  float pch1ai;
  float pch1i;
  float pochai;
  float sum;
...
//
{
  ...
  const float eul = 0.57721566490153286E+00;
  float f;
  float g;
  static int ncin = 0;
  float sinx;
...
//
{
  ...
  int n2;
  static int ntsn = 0;
  const float pi2 = 1.570796326794896619E+00;
  const float pi2rec = 0.636619772367581343E+00;
  const float pihi = 3.140625E+00;
  const float pilo = 9.6765358979323846E-04;
  const float pirec = 0.31830988618379067E+00;
...
{
  int n;
  const float raddeg = 0.017453292519943296E+00;
  float value;
...
//
{
  ...
  static float sqeps = 0.0;
  const float sqrtpi = 1.7724538509055160E+00;
  float value;
  static float xbig = 0.0;
  float y;
...
//
{
  const float aln216 = 0.083120654223414518;
...
//
{
  ...
  bool converged;
  static float eps = 0.0;
  const float euler = 0.5772156649015329E+00;
  float fk;
  float fkp1;
  float fm;
  int k;
...
//
{
  float a[15];
  float a0;
  const float aln2 = 0.69314718055994531E+00;
  static float alnbig = 0.0;
  static float alneps = 0.0;
  static float alnsml = 0.0;
  float alnz;
  ...
  static float c0kcs[16] = {
   ...
   -0.000000000000000016E+00 };
  const float euler = 0.57721566490153286E+00;
  float expx;
  int i;
  int ii;
  int inu;
  ...
  float qq;
  float result;
  const float sqpi2 = 1.2533141373155003E+00;
  float sqrtx;
  float v;
  float vlnz;
  float x2n;
...
//
{
  ...
  float sinpiy;
  const float sq2pil = 0.91893853320467274E+00;
  const float sqpi2l = 0.22579135264472743E+00;
  float value;
  static float xmax = 0.0;
  float y;
...
//
{
  const float aln2 = 0.068147180559945309E+00;
...
//
{
  const float aloge = 0.43429448190325182765E+00;
  float value;
...
//
{
  const float aln210 = 3.321928094887362E+00;
  float aln2b;
  static int nmax = 0;
  static int nmin = 0;
  int nsum;
...
//
{
  ...
  int i;
  int n;
  const float pi = 3.141592653589793238E+00;
  float value;
  float sgnga;
  float sgngax;
  float sinpia;
...
//  Parameters:
//
//    Input, float R, determines the action.
...
//
//    Output, float R4_RAND, a pseudo-random number between 0.0 and 1.0.
//
{
  const int ia0 = 1029;
  const int ia1 = 1536;
...
//
{
  ...
  float g;
  static int nsi = 0;
  const float pi2 = 1.5707963267948966E+00;
...
//
{
  ...
  if ( eta < dos[nos-1] )
  {
    ...
    cerr << "  ETA may be too small.\n";
    cerr << "  The requested accuracy cannot be guaranteed\n";
    cerr << "  even if all available coefficients are used.\n";
    value = nos;
  }
  else
  {
