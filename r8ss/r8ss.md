R8SS\
Symmetric Skyline Matrix Utilities {#r8ss-symmetric-skyline-matrix-utilities align="center"}
==================================

------------------------------------------------------------------------

**R8SS** is a C++ library which carries out some basic linear algebra
operations on R8SS matrices (real 64 bit precision symmetric skyline
format).
...
**R8SS** is available in [a C version](../../c_src/r8ss/r8ss.html) and
[a C++ version](../../cpp_src/r8ss/r8ss.html) and [a FORTRAN90
version](../../f_src/r8ss/r8ss.html) and [a MATLAB
version](../../m_src/r8ss/r8ss.html) and [a Python
version](../../py_src/r8ss/r8ss.html)
...
-   [r8ss.cpp](r8ss.cpp), the source code.
-   [r8ss.hpp](r8ss.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8ss\_prb.cpp](r8ss_prb.cpp) a sample calling program.
-   [r8ss\_prb\_output.txt](r8ss_prb_output.txt), the output file.
...
-   **R8SS\_DIF2** sets up an R8SS second difference matrix.
-   **R8SS\_ERROR** checks dimensions for an R8SS matrix.
-   **R8SS\_INDICATOR** sets up an R8SS indicator matrix.
-   **R8SS\_MV** multiplies an R8SS matrix times a vector.
-   **R8SS\_PRINT** prints an R8SS matrix.
-   **R8SS\_PRINT\_SOME** prints some of an R8SS matrix.
-   **R8SS\_RANDOM** randomizes an R8SS matrix.
-   **R8SS\_TO\_R8GE** copies an R8SS matrix to an R8GE matrix.
-   **R8SS\_ZEROS** zeros an R8SS matrix.
