#!/bin/bash
#
g++ -c -I/$HOME/include sgmga_vcn_prb.cpp
if [ $? -ne 0 ]; then
  echo "Errors compiling sgmga_vcn_prb.cpp"
  exit
fi
#
g++ sgmga_vcn_prb.o /$HOME/libcpp/$ARCH/sgmga.o /$HOME/libcpp/$ARCH/sandia_rules.o -lm
if [ $? -ne 0 ]; then
