R8SD\
Symmetric Diagonal Linear Algebra Utilities {#r8sd-symmetric-diagonal-linear-algebra-utilities align="center"}
===========================================

------------------------------------------------------------------------

**R8SD** is a C++ library which carries out some basic linear algebra
operations on R8SD matrices (real 64 bit precision symmetric diagonal
format).
...
**R8SD** is available in [a C version](../../c_src/r8sd/r8sd.html) and
[a C++ version](../../cpp_src/r8sd/r8sd.html) and [a FORTRAN90
version](../../f_src/r8sd/r8sd.html) and [a MATLAB
version](../../m_src/r8sd/r8sd.html) and [a Python
version.](../../py_src/r8sd/r8sd.html)
...
-   [r8sd.cpp](r8sd.cpp), the source code.
-   [r8sd.hpp](r8sd.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8sd\_prb.cpp](r8sd_prb.cpp) a sample calling program.
-   [r8sd\_prb\_output.txt](r8sd_prb_output.txt), the output file.
...
-   **R8SD\_CG** uses the conjugate gradient method on an R8SD linear
    system.
-   **R8SD\_DIF2** returns the DIF2 matrix in R8SD format.
-   **R8SD\_INDICATOR** sets up an R8SD indicator matrix.
-   **R8SD\_MV** multiplies an R8SD matrix times a vector.
-   **R8SD\_PRINT** prints an R8SD matrix.
-   **R8SD\_PRINT\_SOME** prints some of an R8SD matrix.
-   **R8SD\_RANDOM** randomizes an R8SD matrix.
-   **R8SD\_RES** computes the residual R = B-A\*X for R8SD matrices.
-   **R8SD\_TO\_R8GE** copies an R8SD matrix to an R8GE matrix.
-   **R8SD\_ZEROS** zeros an R8SD matrix.
