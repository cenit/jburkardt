...
//  Purpose:
//
//    EASTER_DS_TEST tests EASTER_DS.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//
{
  ...
  cout << "  EASTER_DS uses Duffett-Smith''s algorithm.\n";
...
void easter_egr_test ( )

//****************************************************************************80
//
//  Purpose:
//
//    EASTER_EGR_TEST tests EASTER_EGR.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//
{
  ...
  cout << "\n";
  cout << "EASTER_EGR_TEST\n";
  cout << "  For the Gregorian calendar,\n";
  cout << "  for a given year, compute the day and month of Easter.\n";
  cout << "  EASTER_EGR uses Richard's algorithm.\n";
...
//  Purpose:
//
//    EPOCH_TO_JED_DATENUM returns the epoch of the MATLAB DATENUM calendar as a JED.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//
//    Output, bool JED_IS_LEGAL, TRUE if JED is legal, FALSE otherwise.
{
  bool value;
...
//
{
  double bessel;
  double jed_epoch;
  double year_length_days = 365.242198781;

  jed_epoch = epoch_to_jed_bessel ( );
  bessel = 1900.0 + ( jed - jed_epoch ) / year_length_days;
...
//
{
  double jed_epoch;
  double julian;
  double year_length_days = 365.25;

  jed_epoch = epoch_to_jed_y2k ( );

  julian = 2000.0 + ( jed - jed_epoch ) / year_length_days;
...
//
  ...
  while ( year_length_days_eg_lunar ( y ) < d )
  {
...
//
{
  ...
  days = year_length_days_hindu_solar ( ) / 12.0;
...
int year_length_days_alexandrian ( int y )

//****************************************************************************80
//
//  Purpose:
//
//    YEAR_LENGTH_DAYS_ALEXANDRIAN returns the number of days in an Alexandrian year.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_ALEXANDRIAN, the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_bahai ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_BAHAI, the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_coptic ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_COPTIC, the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_eg_civil ( int y )

//****************************************************************************80
//
//  Purpose:
//
//    YEAR_LENGTH_DAYS_EG_CIVIL returns the number of days in an Egyptian Civil year.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_EG_CIVIL, the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_eg_lunar ( int y )

//****************************************************************************80
//
//  Purpose:
//
//    YEAR_LENGTH_DAYS_EG_LUNAR returns the number of days in an Egyptian lunar year.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_EG_LUNAR, the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_english ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_ENGLISH, the number of 
//    days in the year.
//
{
  int days;
  ...
  {
    cerr << "\n";
    cerr << "YEAR_LENGTH_DAYS_ENGLISH - Fatal error!\n";
    cerr << "  Illegal Y = 0.\n";
    exit ( 1 );
  }
...
int year_length_days_ethiopian ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_ETHIOPIAN, the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_greek ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_GREEK, the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_gregorian ( int y )

//****************************************************************************80
//
//  Purpose:
//
//    YEAR_LENGTH_DAYS_GREGORIAN returns the number of days in a Greegorian year.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_GREGORIAN, the number of 
//    days in the year.
//
{
  int days;
  ...
  {
    cerr << "\n";
    cerr << "YEAR_LENGTH_DAYS_GREGORIAN - Fatal error!\n";
    cerr << "  Illegal Y = 0.\n";
    exit ( 1 );
  }
...
int year_length_days_hebrew ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_HEBREW, the number of 
//    days in the year.
//
{
  int days;
...
double year_length_days_hindu_solar ( )

//****************************************************************************80
//
//  Purpose:
//
//    YEAR_LENGTH_DAYS_HINDU_SOLAR returns the number of days in a Hindu solar year.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//  Parameters:
//
//    Output, double YEAR_LENGTH_DAYS_HINDU_SOLAR, the number of 
//    days in the year.
//
{
  double days;
...
int year_length_days_islamic ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_ISLAMIC the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_julian ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_JULIAN, the number of 
//    days in the year.
//
{
  int days;
...
double year_length_days_lunar ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, double YEAR_LENGTH_DAYS_LUNAR, the number of 
//    days in the year.
//
{
  double days;
...
int year_length_days_persian ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_PERSIAN the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_republican ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_REPUBLICAN, the number of 
//    days in the year.
//
{
  int days;
...
int year_length_days_roman ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, int YEAR_LENGTH_DAYS_ROMAN, the number of 
//    days in the year.
//
{
  int days;
...
double year_length_days_solar ( int y )
...
//    Input, int Y, the year to be checked.
//
//    Output, double YEAR_LENGTH_DAYS_SOLAR, the number of 
//    days in the year.
//
{
  double days;
...
//
{
  ...
  year_length_days = ( r8_nint ) ( jed2 - jed );

       if ( year_length_days == 353 )
  {
    type = 1;
  }
  else if ( year_length_days == 354 )
  {
    type = 2;
  }
  else if ( year_length_days == 355 )
  {
    type = 3;
  }
  else if ( year_length_days == 383 )
  {
    type = 4;
  }
  else if ( year_length_days == 384 )
  {
    type = 5;
  }
  else if ( year_length_days == 385 )
  {
    type = 6;
  }
  else
...
string ymd_to_s_gregorian ( int y, int m, int d )
...
//
{
  ...
  if ( 0 <= y )
  {
    sprintf ( s_char, "AD %d/%02d/%02d", y, m, d );
  }
  else
  {
    sprintf ( s_char, "BC %d/%02d/%02d", -y, m, d );
  }
...
//
{
  ...
  jed = jed_epoch +
    ...
    + ( double ) ( y ) * year_length_days_hindu_solar ( );
...
//    Input, int Y, M, D, double F, the YMDF date.
//
//    Output, double YMDF_TO_JED_ISLAMIC_A, the corresponding Julian 
//    Ephemeris Date.
//
{
  int d_prime;
...
string ymdf_to_s_common ( int y, int m, int d, double f )
...
//  Parameters:
//
//    Input, int Y, M, D, F, the YMDF date.
//
//    Output, string S, a representation of the date.
//
{
  ...
  if ( 0 <= y )
  {
    sprintf ( s_char, "CE %d/%02d/%02d%.2f", y, m, d, f );
  }
  else
  {
    sprintf ( s_char, "BCE %d/%02d/%02d%.2f", -y, m, d, f );
  }
