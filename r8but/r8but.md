R8BUT\
Band Upper Triangular Matrix Utilities {#r8but-band-upper-triangular-matrix-utilities align="center"}
======================================

------------------------------------------------------------------------

**R8BUT** is a C++ library which carries out some basic linear algebra
operations on R8BUT matrices (real 64 bit precision band upper
triangular format).
...
**R8BUT** is available in [a C version](../../c_src/r8but/r8but.html)
and [a C++ version](../../cpp_src/r8but/r8but.html) and [a FORTRAN90
version](../../f_src/r8but/r8but.html) and [a MATLAB
version](../../m_src/r8but/r8but.html) and [a Python
version.](../../py_src/r8but/r8but.html)
...
-   [r8but.cpp](r8but.cpp), the source code.
-   [r8but.hpp](r8but.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8but\_prb.cpp](r8but_prb.cpp), a sample calling program.
-   [r8but\_prb\_output.txt](r8but_prb_output.txt), the output file.
...
-   **R8BUT\_DET** computes the determinant of an R8BUT matrix.
-   **R8BUT\_INDICATOR** sets up an R8BUT indicator matrix.
-   **R8BUT\_MTV** multiplies an R8VEC by an R8BUT matrix.
-   **R8BUT\_MV** multiplies an R8BUT matrix by an R8VEC.
-   **R8BUT\_PRINT** prints an R8BUT matrix.
-   **R8BUT\_PRINT\_SOME** prints some of an R8BUT matrix.
-   **R8BUT\_RANDOM** randomizes an R8BUT matrix.
-   **R8BUT\_SL** solves an R8BUT system A\*x=b.
-   **R8BUT\_SLT** solves an R8BUT system A'\*x=b.
-   **R8BUT\_TO\_R8GE** copies an R8BUT matrix to an R8GE matrix.
-   **R8BUT\_ZEROS** zeroes an R8BUT matrix.
...
*Last revised on 13 October 2015.*
