...
//
  ...
  for ( i = 1; i <= P; i++ )
  {
    row = c4vec_uniform_01_new ( P, seed );
...
//
  ...
  a = c4mat_uniform_01_new ( N, N, seed );
...
# define P 3
  ...
  cout << "\n";
  cout << "CQRDC_TEST\n";
  cout << "  CQRDC computes the QR decomposition of a rectangular\n";
...
//
  ...
  a = c4mat_uniform_01_new ( N, P, seed );
