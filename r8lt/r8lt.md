R8LT\
Linear Algebra Utilities {#r8lt-linear-algebra-utilities align="center"}
========================

------------------------------------------------------------------------

**R8LT** is a C++ library which carries out some basic linear algebra
operations on R8LT matrices (real 64 bit precision lower triangular
format).
...
**R8LT** is available in [a C version](../../c_src/r8lt/r8lt.md) and
[a C++ version](../../master/r8lt/r8lt.md) and [a FORTRAN90
version](../../f_src/r8lt/r8lt.md) and [a MATLAB
version](../../m_src/r8lt/r8lt.md) and [a Python
version](../../py_src/r8lt/r8lt.md)
...
-   [r8lt.cpp](r8lt.cpp), the source code;
-   [r8lt.hpp](r8lt.hpp), the include file;

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8lt\_prb.cpp](r8lt_prb.cpp), the calling program;
-   [r8lt\_prb\_output.txt](r8lt_prb_output.txt), the output file.
...
-   **R8LT\_DET** computes the determinant of an R8LT matrix.
-   **R8LT\_INDICATOR** sets up an R8LT indicator matrix.
-   **R8LT\_INVERSE** computes the inverse of an R8LT matrix.
-   **R8LT\_MM** multiplies two R8LT matrices.
-   **R8LT\_MTM** computes C=A'\*B for R8LT matrices.
-   **R8LT\_MTV** multiplies an R8VEC by an R8LT matrix.
-   **R8LT\_MV** multiplies an R8LT matrix by an R8VEC.
-   **R8LT\_PRINT** prints an R8LT matrix.
-   **R8LT\_PRINT\_SOME** prints some of an R8LT matrix.
-   **R8LT\_RANDOM** randomizes an R8LT matrix.
-   **R8LT\_SL** solves A\*x=b, where A is an R8LT matrix.
-   **R8LT\_SLT** solves A'\*x=b where A is an R8LT matrix.
-   **R8LT\_TO\_R8GE** copies an R8LT matrix to an R8GE matrix.
-   **R8LT\_ZEROS** zeroes an R8LT matrix.
...
*Last revised on 23 August 2015.*
