...
//
{
  ...
  cout << "\n";
  cout << "CHEBYSHEV1_EXACTNESS_TEST\n";
...
//
{
  ...
  cout << "\n";
  cout << "CHEBYSHEV2_EXACTNESS_TEST\n";
...
//
{
  ...
  cout << "\n";
  cout << "CHEBYSHEV3_EXACTNESS_TEST\n";
...
//
{
  ...
  cout << "\n";
  cout << "CLENSHAW_CURTIS_EXACTNESS_TEST\n";
...
//
{
  ...
  cout << "\n";
  cout << "GEGENBAUER_EXACTNESS_TEST\n";
  cout << "  Gauss-Gegenbauer rules for the Gegenbauer integral.\n";
  cout << "  Density function rho(x) = 1.\n";
  cout << "  Region: -1 <= x <= +1.\n";
...
//
{
  ...
  cout << "\n";
  cout << "LAGUERRE_1_EXACTNESS_TEST\n";
  cout << "  Gauss-Laguerre rules for the Laguerre integral.\n";
  cout << "  Density function rho(x) = 1.\n";
  cout << "  Region: 0 <= x < +oo.\n";
  cout << "  Exactness: 2N-1.\n";
