R8GE\_NP\
General Storage Nonpivoting Matrix Utilities {#r8ge_np-general-storage-nonpivoting-matrix-utilities align="center"}
============================================

------------------------------------------------------------------------

**R8GE\_NP** is a C++ library which carries out nonpivoting linear
algebra operations on R8GE\_NP matrices (real 64 bit precision general
nonpivoting MxN format).
...
**R8GE\_NP** is available in [a C
version](../../c_src/r8ge_np/r8ge_np.html) and [a C++
version](../../cpp_src/r8ge_np/r8ge_np.html) and [a FORTRAN90
version](../../f_src/r8ge_np/r8ge_np.html) and [a MATLAB
version](../../m_src/r8ge_np/r8ge_np.html) and [a Python
version.](../../py_src/r8ge_np/r8ge_np.html)
...
-   [r8ge\_np.cpp](r8ge_np.cpp), the source code.
-   [r8ge\_np.hpp](r8ge_np.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8ge\_np\_prb.cpp](r8ge_np_prb.cpp) a sample calling program.
-   [r8ge\_np\_prb\_output.txt](r8ge_np_prb_output.txt), the output
    file.
...
-   **R8GE\_NP\_DET** computes the determinant of a matrix factored by
    R8GE\_NP\_FA.
-   **R8GE\_NP\_FA** factors an R8GE matrix by nonpivoting Gaussian
    elimination.
-   **R8GE\_NP\_INVERSE** computes the inverse of a matrix factored by
    R8GE\_NP\_FA.
-   **R8GE\_NP\_ML** computes A \* x or x \* A, for a matrix factored by
    R8GE\_NP\_FA.
-   **R8GE\_NP\_SL** solves a system factored by R8GE\_NP\_FA.
-   **R8GE\_NP\_TRF** computes the LU factorization of an R8GE matrix.
-   **R8GE\_NP\_TRM** computes A \* x or A' \* x, for a matrix factored
    by R8GE\_NP\_TRF.
-   **R8GE\_NP\_TRS** solves a system of linear equations factored by
    R8GE\_NP\_TRF.
