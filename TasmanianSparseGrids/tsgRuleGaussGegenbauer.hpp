...
#ifndef __TASMANIAN_SPARSE_GRID_RULE_GG_HPP
#define __TASMANIAN_SPARSE_GRID_RULE_GG_HPP
...
class RuleGaussGegenbauer : public OneDRule{
public:
        RuleGaussGegenbauer( const int max_level, double walpha );
        ~RuleGaussGegenbauer();
