...
#ifndef __TASMANIAN_SPARSE_GRID_RULE_GC2_HPP
#define __TASMANIAN_SPARSE_GRID_RULE_GC2_HPP
...
class RuleGaussChebyshev2 : public OneDRule{
public:
        RuleGaussChebyshev2( const int level );
        ~RuleGaussChebyshev2();
