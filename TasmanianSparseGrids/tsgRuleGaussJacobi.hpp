...
#ifndef __TASMANIAN_SPARSE_GRID_RULE_GJ_HPP
#define __TASMANIAN_SPARSE_GRID_RULE_GJ_HPP
...
class RuleGaussJacobi : public OneDRule{
public:
        RuleGaussJacobi( const int max_level, double walpha, double wbeta );
        ~RuleGaussJacobi();
