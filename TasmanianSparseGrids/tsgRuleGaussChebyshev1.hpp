...
#ifndef __TASMANIAN_SPARSE_GRID_RULE_GC1_HPP
#define __TASMANIAN_SPARSE_GRID_RULE_GC1_HPP
...
class RuleGaussChebyshev1 : public OneDRule{
public:
        RuleGaussChebyshev1( const int level );
        ~RuleGaussChebyshev1();
