...
#ifndef __TASMANIAN_SPARSE_GRID_PWLOCAL_RULE_HPP
#define __TASMANIAN_SPARSE_GRID_PWLOCAL_RULE_HPP
...
class RulePieceWiseLocal : public OneDHierarchicalRule{
public:
        RulePieceWiseLocal( int max_order = 1 );
        ~RulePieceWiseLocal();
...
private:
        ...
        int firstFewParents[5];// = { -1, 0, 0, 1, 2 };
