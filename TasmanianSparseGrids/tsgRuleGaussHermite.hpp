...
#ifndef __TASMANIAN_SPARSE_GRID_RULE_GH_HPP
#define __TASMANIAN_SPARSE_GRID_RULE_GH_HPP
...
class RuleGaussHermite : public OneDRule{
public:
        RuleGaussHermite( const int max_level, double walpha );
        ~RuleGaussHermite();
