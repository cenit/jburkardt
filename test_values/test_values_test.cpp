...
//
  ...
  cout << "\n";
  cout << "BESSEL_J_SPHERICAL_VALUES_TEST:\n";
  cout << "  BESSEL_J_SPHERICAL_VALUES stores values of\n";
  cout << "  the spherical Bessel jn function.\n";
  cout << "\n";
  cout << "      N      X            jn(X)\n";
  cout << "\n";
...
//
  ...
  cout << "\n";
  cout << "LEGENDRE_NORMALIZED_POLYNOMIAL_VALUES_TEST:\n";
  cout << "  LEGENDRE_NORMALIZED_POLYNOMIAL_VALUES stores values of \n";
  cout << "  the normalized Legendre polynomials.\n";
  cout << "\n";
  cout << "     N    X             Pn(N)(X)\n";
  cout << "\n";
...
//
  ...
  cout << "\n";
  cout << "LEGENDRE_POLYNOMIAL_VALUES_TEST:\n";
  cout << "  LEGENDRE_POLYNOMIAL_VALUES stores values of \n";
...
//
  ...
  cout << "\n";
  cout << "LEGENDRE_SHIFTED_POLYNOMIAL_VALUES_TEST:\n";
  cout << "  LEGENDRE_SHIFTED_POLYNOMIAL_VALUES stores values of \n";
  cout << "  the shifted Legendre polynomials.\n";
  cout << "\n";
  cout << "     N    X             P(N)(X)\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "MITTAG_LEFFLER_EA_VALUES_TEST:\n";
  cout << "   MITTAG_LEFFLER_EA_VALUES stores values of\n";
  cout << "   the Mittag-Leffler one-parameter function E(A;X).\n";
  cout << "\n";
  cout << "      A            X            E(A;X)\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "MITTAG_LEFFLER_EAB_VALUES_TEST:\n";
  cout << "   MITTAG_LEFFLER_EAB_VALUES stores values of\n";
  cout << "   the Mittag-Leffler two-parameter function E(A,B;X).\n";
  cout << "\n";
  cout << "      A            B             X            E(A,B;X)\n";
  cout << "\n";
...
//
  ...
  cout << "\n";
  cout << "WRIGHT_OMEGA_VALUES_TEST:\n";
  cout << "  WRIGHT_OMEGA_VALUES stores values of \n";
  cout << "  the Wright Omega function.\n";
  cout << "\n";
  cout << "                Z                     FZ\n";
  cout << "\n";
  ...
  for ( ; ; )
  {
    ...
    cout                                                   << "  "
         << setw(14) << setprecision ( 6 ) << real ( z )   << "  "
         << setw(14) << setprecision ( 6 ) << imag ( z )   << "  "
         << setw(24) << setprecision (16 ) << real ( fz ) << "  "
         << setw(24) << setprecision (16 ) << imag ( fz ) << "\n";
  }
//
//  Restore the default precision.
//
...
//
  ...
  cout << "\n";
  cout << "ZETA_M1_VALUES_TEST:\n";
  cout << "  ZETA_M1_VALUES returns values of \n";
  cout << "  the Riemann Zeta Minus One function.\n";
  cout << "\n";
  cout << "     N        ZETA_M1(N)\n";
  cout << "\n";
  ...
  for ( ; ; )
  {
    zeta_m1_values ( n_data, p, zeta_m1 );
    ...
    cout << setw(6)                      << p    << "  "
         << setw(24) << setprecision(16) << zeta_m1 << "\n";
  }
//
//  Restore the default precision.
//
