R8BB\
Border Banded Matrix Utilities {#r8bb-border-banded-matrix-utilities align="center"}
==============================

------------------------------------------------------------------------

**R8BB** is a C++ library which carries out some basic linear algebra
operations on R8BB matrices (real 64 bit precision Border Banded
format).
...
**R8BB** is available in [a C version](../../c_src/r8bb/r8bb.html) and
[a C++ version](../../cpp_src/r8bb/r8bb.html) and [a FORTRAN90
version](../../f_src/r8bb/r8bb.html) and [a MATLAB
version](../../m_src/r8bb/r8bb.html) and [a Python
version](../../py_src/r8bb/r8bb.html)
...
contains linear algebra routines for R83 matrices (real, 64 bit,
tridiagonal 3xN format, nonpivoting option).
...
linear algebra routines for RB8LT matrices (real, 64 bit, band lower
triangular format).
...
linear algebra routines for R8SM matrices (real, 64 bit, A-u\*v'
format).
...
-   [r8bb.cpp](r8bb.cpp), the source code.
-   [r8bb.hpp](r8bb.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8bb\_prb.cpp](r8bb_prb.cpp) a sample calling program.
-   [r8bb\_prb\_output.txt](r8bb_prb_output.txt), the output file.
...
-   **R8BB\_ADD** adds a value to an entry in an R8BB matrix.
-   **R8BB\_DIF2** sets up an R8BB second difference matrix.
-   **R8BB\_FA** factors an R8BB matrix.
-   **R8BB\_GET** gets a value of an R8BB matrix.
-   **R8BB\_INDICATOR** sets up an R8BB indicator matrix.
-   **R8BB\_MTV** multiplies a vector by an R8BB matrix.
-   **R8BB\_MV** multiplies an R8BB matrix times a vector.
-   **R8BB\_PRINT** prints an R8BB matrix.
-   **R8BB\_PRINT\_SOME** prints some of an R8BB matrix.
-   **R8BB\_RANDOM** randomizes an R8BB matrix.
-   **R8BB\_SET** sets a value of an R8BB matrix.
-   **R8BB\_TO\_R8GE** copies an R8BB matrix to an R8GE matrix.
-   **R8BB\_ZEROS** zeros an R8BB matrix.
