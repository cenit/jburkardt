R8RI\
Row-Indexed Array Linear Algebra Utilities {#r8ri-row-indexed-array-linear-algebra-utilities align="center"}
==========================================

------------------------------------------------------------------------

**R8RI** is a C++ library which carries out some basic linear algebra
operations on R8RI matrices (real 64 bit precision row indexed format).
...
**R8RI** is available in [a C version](../../c_src/r8ri/r8ri.html) and
[a C++ version](../../cpp_src/r8ri/r8ri.html) and [a FORTRAN90
version](../../f_src/r8ri/r8ri.html) and [a MATLAB
version](../../m_src/r8ri/r8ri.html) and [a Python
version.](../../py_src/r8ri/r8ri.html)
...
-   [r8ri.cpp](r8ri.cpp), the source code.
-   [r8ri.hpp](r8ri.hpp), the include file.

### Examples and Tests: {#examples-and-tests align="center"}

-   [r8ri\_prb.cpp](r8ri_prb.cpp) a sample calling program.
-   [r8ri\_prb\_output.txt](r8ri_prb_output.txt), the output file.
...
-   **R8RI\_DIF2** stores the second difference matrix in R8RI format.
-   **R8RI\_INDICATOR** returns the R8RI indicator matrix for given
    sparsity.
-   **R8RI\_MTV** multiplies the transpose of an R8RI matrix times a
    vector.
-   **R8RI\_MV** multiplies an R8RI matrix times a vector.
-   **R8RI\_PRINT** prints an R8RI matrix.
-   **R8RI\_PRINT\_SOME** prints some of an R8RI matrix.
-   **R8RI\_RANDOM** randomizes an R8RI matrix for given sparsity.
-   **R8RI\_TO\_R8GE** converts an R8RI matrix to R8GE form.
-   **R8RI\_ZEROS** zeros an R8RI matrix.
